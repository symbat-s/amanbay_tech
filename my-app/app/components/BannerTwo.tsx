...
const BannerTwo: React.FC = () => {
   return (
    <div className="relative w-full flex justify-center py-20 px-10">
      ...
      <div id="1" className="relative z-20 flex flex-col gap-[130px] right-[110px] " >
     
        <div className="relative flex items-start gap-4">
          
          <div className="bg-white border border-[#00000014] p-[20px] w-[490px] h-[180px] transition-transform duration-500 ease-in-out hover:scale-110">
