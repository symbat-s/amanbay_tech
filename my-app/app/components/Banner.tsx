...
export default function Banner() {
  return (
     <div className="flex gap-[225px]"style={{ fontFamily: "Poppins" }}>
        ...
        <a href="https://amanbay.tech/en#explore"><button className="w-[250px] h-[65px] ml-[80px] bg-[#EA4D46] text-[white] text-center text-2xl rounded-[10px] mt-[70px]">Show services</button></a>
        </div>

        <div>
           <Image src="/image/PeakBanner.png" alt="Баннер" width={466} height={400} className="absolute mr-[50px] mb-10" />
        </div>
     </div>
  );
}