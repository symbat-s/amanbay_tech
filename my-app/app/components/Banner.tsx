  ...
  return (
    <div className='md:flex block gap-15'>
     <div className="md:ml-15 mt-20 p-10 md:mt-50 space-y-5 ">
      ...
      <Link href="#contact" className='border border-[#505050] hover:text-[white] hover:bg-[#505050] text-sm md:text-lg text-[#505050] font-bold p-2 md:py-3 md:px-5 rounded-4xl '>Our services</Link>
     </div>
     <Image 
      src="/foto/banner.png" 
      alt="laptop"
