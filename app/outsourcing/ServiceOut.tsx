        ...
        <div className="flex pr-5 sm:p-15 md:p-25 mt-20 sm:mt-10">
          <img src={foto.src} alt={foto.alt} className="w-50 h-50  sm:w-100 sm:h-100 md:w-160 md:h-150 " />
            <div className="text-[#404040]">
              ...
              <div className="sd:mt-24 md:mt-24  sd:pr-0 md:pr-0 mt-4">
              ...
              <div className="mt-4 sd:mt-15 md:mt-15  sd:pr-0 md:pr-0">
              ...
              <div className="mt-[2px] sd:mt-18 md:mt-18 sd:pr-0 md:pr-0">
